	...
	return {
		...
		initialize: function() {
			...
			if( direction === 'vertical' ) {
				if ( skin === "vector" ) {
					this.postVector( leadingDescriptionVertical );
				} else if ( skin === "modern" ) {
					this.postOther( '#mw_portlets', leadingDescriptionVertical );
				} else if ( skin === "monobook" ) {
					this.postOther( '#column-one', leadingDescriptionVertical );
				} else if ( skin === "cologneblue" ) {
					this.postOther( '#quickbar', leadingDescriptionVertical );
				}
